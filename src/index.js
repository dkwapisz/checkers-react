...
class Board extends React.Component {
    ...
    backToState(index) {
        this.setState({board: this.state.history[index]})
        //this.state.board = this.state.history[index]
        this.setState({redTurn: this.state.whichTurnHistory[index]})
        //this.state.redTurn = this.state.whichTurnHistory[index]
    }
        ...
        return (
            ...
            <div>
                ...
                <div className="info">
                    ...
                    <div className="redTimer">
                        Red Player Timer: xxx
                    </div>
                    <div className="blackTimer">
                        Red Player Timer: xxx
                    </div>
